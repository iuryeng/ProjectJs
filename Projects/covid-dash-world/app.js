...
let inforDeaths; //armazena quantidade de mortes 
let inforRecovered;//armazena qunatidade de casos recuperados 
let newCases;//armazena a quantidade de novos casos
let newDeaths;//armazena a quantidade de novas mortes 
let tests1m;//armazena a quantidade de testes por 1 milhão de população 
let testTotais;//armazena a quantidade total de testes
let cases1m;//armazena a quantidade de casos por 1 milhão de população
let mortes1m;// armazena a quantidade de mortes por 1 milão de população
...
/*Captando dados e populando a tabela dinamicamente*/
$(document).ready(function(){ 
...
async function getCountryDropDow(){ // funcao para pegar valores de dados por pais
...
return sortOptions("dropdown1");
 ...
 function sortOptions(id){ // Colocar a opção dos paises em ordem alfabetica
...
function buildInforChart(){
  ...
  /*passando o valor capturado para o html*/
  ...
  function createCanvas(){ // criar canvas que irá guardar o gráfico     
    canvas = document.getElementById("chart-canvas");  
    chartCanvas = document.createElement("canvas");
    canvas.appendChild(chartCanvas);  
    chartCanvas.setAttribute("id", "chartCountryCases");
    chartCanvas.classList.add("chart")
  } 

  function removeCanvas(){ // removendo elemento canvas 
    var element = document.getElementById("chartCountryCases");
